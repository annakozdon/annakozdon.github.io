...
function showJobDetail(id){
  ...
  document.getElementById('dt-match-chips-plus').innerHTML=matches.map((e)=>`<div class="match-pill" style="display: inline-flex; align-content: center; align-items: center; border: 1px; background: #B8DFC0; color: #28A35A; borderColor: #28A35A">
