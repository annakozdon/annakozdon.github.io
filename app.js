...
function showJobDetail(id){
  ...
  document.getElementById('dt-match-chips-minus').innerHTML=mismatches.map((e)=>`<div class="chip" style="border: 1px; background: #F0BABA; color: #C83232; borderColor: #C83232">
